...
import { clamp01, createPainter, displace, easeOutQuad, reformParticle } from "../lib/dustPainter";
  ...
  useEffect(() => {
    ...
    const draw = (ts: number) => {
      ...
      if (current === "out") {
        ...
        // Mesma remontagem que as seções usam ao entrar em cena.
        for (const p of incoming) {
          reformParticle(painter, p, elapsed, SWEEP_IN_MS, FLIGHT_IN_MS, H);
        }
