...
- O fluxo principal do produto é enviar uma mensagem em `#contato`. Não há e-mail server-side: o formulário valida no cliente, mostra a confirmação e monta um `mailto:`.
